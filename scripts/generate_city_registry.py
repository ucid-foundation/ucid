...
def get_city_registry() -> List[CityEntry]:
    ...
    return [
        ...
        CityEntry("LAX", "Los Angeles", "US", 34.0522, -118.2437, "America/Los_Angeles", 3_979_000),
        CityEntry("CHI", "Chicago", "US", 41.8781, -87.6298, "America/Chicago", 2_693_000),
        CityEntry("SFO", "San Francisco", "US", 37.7749, -122.4194, "America/Los_Angeles", 874_000),
        ...
        CityEntry("MEX", "Mexico City", "MX", 19.4326, -99.1332, "America/Mexico_City", 8_855_000),
        ...
        CityEntry("MEL", "Melbourne", "AU", -37.8136, 144.9631, "Australia/Melbourne", 5_078_000),
        CityEntry("AKL", "Auckland", "NZ", -36.8509, 174.7645, "Pacific/Auckland", 1_657_000),

        # South America
        CityEntry("GRU", "São Paulo", "BR", -23.5505, -46.6333, "America/Sao_Paulo", 12_330_000),
        CityEntry("GIG", "Rio de Janeiro", "BR", -22.9068, -43.1729, "America/Sao_Paulo", 6_748_000),
        CityEntry("EZE", "Buenos Aires", "AR", -34.6037, -58.3816, "America/Argentina/Buenos_Aires", 2_891_000),
        ...
        CityEntry("JNB", "Johannesburg", "ZA", -26.2041, 28.0473, "Africa/Johannesburg", 5_635_000),
        CityEntry("CPT", "Cape Town", "ZA", -33.9249, 18.4241, "Africa/Johannesburg", 4_005_000),
